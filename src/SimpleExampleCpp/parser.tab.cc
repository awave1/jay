...
#line 622 "parser.tab.cc"
  ...
  case 3:
#line 41 "parser.yy"
          { (yylhs.value.nodeVal) = new ASTNode{"=", {(yystack_[2].value.nodeVal), (yystack_[0].value.nodeVal)}}; }
...
#line 634 "parser.tab.cc"
  ...
  case 5:
#line 45 "parser.yy"
              { (yylhs.value.nodeVal) = new ASTNode{"*", {(yystack_[0].value.nodeVal)}}; }
#line 640 "parser.tab.cc"
    break;

  case 6:
#line 46 "parser.yy"
              { (yylhs.value.nodeVal) = new ASTNode{*(yystack_[0].value.strVal), {}}; }
#line 646 "parser.tab.cc"
    break;
...
#undef YYCASE_
  ...
  {
  "$end", "error", "$undefined", "\"id\"", "\"eq\"", "\"asterisk\"",
  "\"error token\"", "$accept", "START", "S", "L", "R", YY_NULLPTR
  };
